...
d.add_edge('a', 'b', 2,d.graph)  
d.add_edge('a', 'c', 8,d.graph)
d.add_edge('a', 'e', 7,d.graph)
d.add_edge('b','c',5,d.graph)
d.add_edge('b', 'd', 7,d.graph)
d.add_edge('c', 'd', 9,d.graph)
d.add_edge('c', 'e', 8,d.graph)
d.add_edge('e', 'f', 3,d.graph)
d.add_edge('d', 'f', 4,d.graph)

d.prims_min_spanning_tree(d.graph,'a')
